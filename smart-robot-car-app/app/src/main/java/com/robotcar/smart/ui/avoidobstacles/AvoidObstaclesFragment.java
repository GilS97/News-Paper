package com.robotcar.smart.ui.avoidobstacles;
...
public class AvoidObstaclesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        bluetoothViewModel.startMode(CommandProtocol.MODE_AVOIDANCE);
    ...
    private void setupViews(View view) {
        ...
        titleText.setText(R.string.avoid_obstacles);

        ImageView modeIcon = view.findViewById(R.id.modeIcon);
        modeIcon.setImageResource(android.R.drawable.ic_dialog_alert);

        TextView descriptionText = view.findViewById(R.id.descriptionText);
        descriptionText.setText("The robot is navigating and avoiding obstacles");
