package com.robotcar.smart.ui.lightseeking;
...
public class LightSeekingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // Start light seeking mode
        bluetoothViewModel.startMode(CommandProtocol.MODE_LIGHT_SEEKING);
    ...
    private void setupViews(View view) {
        ...
        titleText.setText(R.string.light_seeking);

        ImageView modeIcon = view.findViewById(R.id.modeIcon);
        modeIcon.setImageResource(android.R.drawable.ic_menu_day);

        TextView descriptionText = view.findViewById(R.id.descriptionText);
        descriptionText.setText("The robot is seeking and moving towards light sources");
