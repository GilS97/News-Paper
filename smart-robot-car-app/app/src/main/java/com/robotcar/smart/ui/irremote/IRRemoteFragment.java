package com.robotcar.smart.ui.irremote;
...
public class IRRemoteFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // Start IR remote mode
        bluetoothViewModel.startMode(CommandProtocol.MODE_IR_REMOTE);
    ...
    private void setupViews(View view) {
        ...
        titleText.setText(R.string.ir_remote);

        ImageView modeIcon = view.findViewById(R.id.modeIcon);
        modeIcon.setImageResource(android.R.drawable.ic_menu_send);

        TextView descriptionText = view.findViewById(R.id.descriptionText);
        descriptionText.setText("Control the robot using the IR remote control");
