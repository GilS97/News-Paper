package com.robotcar.smart.ui.followme;
...
public class FollowMeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // Start follow mode
        bluetoothViewModel.startMode(CommandProtocol.MODE_FOLLOW);
    ...
    private void setupViews(View view) {
        ...
        titleText.setText(R.string.follow_me);

        ImageView modeIcon = view.findViewById(R.id.modeIcon);
        modeIcon.setImageResource(android.R.drawable.ic_menu_mylocation);

        TextView descriptionText = view.findViewById(R.id.descriptionText);
        descriptionText.setText("The robot is following you using ultrasonic sensors");
